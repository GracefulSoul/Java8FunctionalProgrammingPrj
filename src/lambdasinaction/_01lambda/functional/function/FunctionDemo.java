...
public class FunctionDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println(getColorList(inventory, new Function<FunctionDemo.Apple, String>() {
			@Override
		...
		// 2. lambda expression
		System.out.println(getColorList(inventory, apple -> apple.getColor()));

		// 3. Method Reference
		// Function<Apple,String> function = Apple :: getColor;
		System.out.println(getColorList(inventory, Apple::getColor));
