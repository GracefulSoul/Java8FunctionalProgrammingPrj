...
public class _03Sorting {
    ...
    public static void main(String...args){
        ...
        System.out.println(Arrays.asList(10, 4, 5, 8, 0, 6).stream().sorted((n1, n2) -> n1.compareTo(n2)).collect(toList()));
        System.out.println(Arrays.asList(10, 4, 5, 8, 0, 6).stream().sorted(Integer::compareTo).collect(toList()));
